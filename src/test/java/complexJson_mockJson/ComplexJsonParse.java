...
public class ComplexJsonParse {
	...
	public static void main(String[] args) {
		...
		JsonPath js = new JsonPath(Payload.CoursePrice());// successfully mocked the response when your Pojo_API is not ready
		...
		//	System.out.println(courseTitles + ": " + js.get("courses[" + i + "].price").toString());
		}
